...
// An IP address is a sequence of four positive integers that are separated by s, where each individual integer is within the range o
// 255, inclusive.
// An IP address isn't valid if any of the individual integers contains leading 0 s. For example, "192.168.0.1" is a valid IP address,
//but "192.168.00.1" and "192.168.0.01" aren't, because they contain "00" and 01, respectively.
...
// Sample Output
// [
// "1.9.216.80", //2 //1680 > 255 // 680 > 255 //80 < 255
// "1.92.16.80",
// "1.92.168.0",
// "19.2.16.80",
// "19.2.168.0",
...
function iPAddresses(string) {
  //valid IP address: only three dots, a number not greater than 255, can't have 00 or 01 - starting from 0;
  // temp arr = [1]
  // let dots = 3; //2
  //const ouput = []
  //for ()
...
console.log(iPAddresses("1921680"));
