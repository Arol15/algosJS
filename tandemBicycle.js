...
// and one that contains the speeds of the bicycle.
// Both lists have the same length, meanining that there are as many red-shirt riders as 
// there are blue-shirt riders. Your goal is to pair every rider wearing a red shirt 
// with a rider wearing a blue shirt to operate a tandem bicycle.
// Write a function that returns the maximum possible total speed 
// or the minimum possible total speed of all of the tandem bicycles being ridden based on an input parameter, 
// fastest .
// If fastest = true your function should return the maximum possible total speed; 
// otherwise it should return the minimum total;
// total speed.
...
// who have speeds of 1, 3, 4, 5, and 
...
// [5, 5, 3, 9, 2] 9, 5, 5, 3, 2
// [3, 6, 7, 2, 1] 1 2 3 6 7 
// Sample Output //9 5 5 6 7 = 32
// 32

function tandemBycicle(redShirtSpeeds, blueShirtSpeeds, fastest) {
  if (fastest) {
